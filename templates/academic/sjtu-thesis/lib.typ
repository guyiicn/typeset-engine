  ...
  fonts = {
    if font-set == "webapp" {
      (
        ...
        math: ("Liberation Serif", (name: "Noto Serif CJK SC", covers: regex("\p{script=Han}"))),
      )
      ...
      (
        en-serif: "Times New Roman",
        en-sans: "Arial",
        songti: ((name: "Times New Roman", covers: "latin-in-cjk"), "Noto Serif CJK SC"),
        heiti: ((name: "Times New Roman", covers: "latin-in-cjk"), "SimHei"),
        kaiti: ((name: "Times New Roman", covers: "latin-in-cjk"), "AR PL UKai CN"),
        fangsong: ((name: "Times New Roman", covers: "latin-in-cjk"), "FangSong"),
        dengkuan: ("Liberation Mono", (name: "SimHei", covers: regex("\p{script=Han}"))),
        math: ("Liberation Serif", (name: "Noto Serif CJK SC", covers: regex("\p{script=Han}"))),
      )
