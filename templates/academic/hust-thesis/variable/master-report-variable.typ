...
#let master-report-cover(
  ...
  set text(size: 14pt, font: "Noto Serif CJK SC")
  v(1em)
  strong([题 目：])
  strong(title)
  text(size: 25pt)[#v(3em)]

  set text(size: 15pt, font: ("Times New Roman", "Noto Serif CJK SC"))
  ...
  v(63pt)
  text(size: 24pt, tracking: 3pt, font: "AR PL UKai CN")[*填表注意事项*]
  v(22.5pt)
...
#let master-report-last-page(date) = {
  ...
  v(500pt)
  set text(size: 14pt, font: ("Times New Roman", "Noto Serif CJK SC"))
