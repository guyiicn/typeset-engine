...
#let 字体 = (
  仿宋: ("Times New Roman", "FangSong", "FZFangSong-Z02"),
  宋体: ("Times New Roman", "Noto Serif CJK SC", "Noto Serif CJK SC"),
  黑体: ("Times New Roman", "SimHei", "SimHei"),
  楷体: ("Times New Roman", "AR PL UKai CN", "AR PL UKai CN"),
  代码: ("Liberation Mono", "Times New Roman", "Noto Serif CJK SC"),
)
